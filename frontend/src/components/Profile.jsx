  ...
  return (
    <div className="w-full h-screen relative overflow-hidden">
      ...
      <div className="absolute z-2 w-full flex justify-end py-[5vh] px-[1vh] lg:p-[2vw] font-[GilM]">
          ...
          <h1 className="lg:text-[1.3vw] text-white ">Welcome, <span className="text-orange-200">{user ? user: "Loading..."}</span>
          </h1>      
          <button onClick={handleLogout} className=" lg:px-[2vw] lg:py-[.8vw] bg-red-600 rounded-md active:scale-95 cursor-pointer text-[2vh] px-[4vh] py-[1vh] lg:text-[1vw] text-white font-semibold uppercase">
          Logout
          </button>
        </div>
      </div>
